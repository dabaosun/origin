...
%{!?commit:
%global commit 01b3df2d733ee681cb268ac9087b3757f92f4619
}
...
%changelog
* Tue Jan 24 2017 Sun Zhenbao <sunzhenbao@nationsky.com> 0.0.2
- hack/env should support incremental rsync to the container
  (ccoleman@redhat.com)
- AWS instances now require 25gb (ccoleman@redhat.com)
